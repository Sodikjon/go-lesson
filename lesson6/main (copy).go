...
// Middle Level
// Напишите программу для управления персональными данными. Реализуйте функции для хранения и вывода имени
//и возраста человека с использованием указателей.

// Напишите программу для учета посещаемости студентов на курсе. Реализуйте функции для отметки студента
//как посетившего курс и вывода списка студентов с их статусом посещения.

// Напишите программу для учета результатов тестирования студентов. Реализуйте функции для добавления
//результатов теста и вывода среднего балла.
